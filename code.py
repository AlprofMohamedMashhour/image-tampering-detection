...
# X_train, X_val, X_test, Y_train, Y_val, Y_test = split_data(X, Y, test_size=0.15, validation_size=0.15, random_state=42)
...
def build_model():
    model = Sequential()
    model.add(Conv2D(filters=64, kernel_size=(3, 3), padding='valid', activation='relu', input_shape=(150, 150, 3)))
    ...
    # Change the last Dense layer for binary classification
